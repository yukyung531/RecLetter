...
///////////////////////////////////////영상 자르기///////////////////////////////////////////////
    ...
    const makeFinalVideo = async () => {
        ...
        if(videoRef.current){
            ...
            await ffmpeg.writeFile('input.mp4', await fetchFile(videoRef.current.src));
            const startTimeString = `00:00:${startTime < 10 ? "0"+startTime : startTime}`
            const endTimeString = `00:00:${endTime < 10 ? "0"+ endTime : endTime}`
