    ...
    const listUpdate = () => {
        if (inputListRef.current !== null) {
            ...
            setUserList((prevData) => {
                const updateSet: Set<string> = new Set<string>([
                    ...prevData,
                    ...newData,
                ]);
        ...
        <>
            <div className="w-[572px] h-[476px] p-2 border-solid border-2 border-[#363636] fixed bg-white flex flex-col">
                ...
                <div className="flex justify-between">
                    <input
                        type="text"
                        className="w-4/5 border-solid border-2 border-[#363636] rounded m-1"
                        ref={inputListRef}
                    />
                    <button
                        onClick={listUpdate}
                        className="w-1/5 rounded bg-[#363636] text-white m-1"
                    >
                        등록
                    </button>
                </div>
