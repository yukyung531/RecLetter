  ...
  public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
    ...
    http
        .authorizeHttpRequests((auth) -> auth
            ...
            .requestMatchers("/auth/email", "/auth/email/code", "/auth/password",
                "/auth/password/code").permitAll()  //이메일 인증(회원가입)
            .requestMatchers("/auth/password", "/auth/password/code", "/user/password")
            .permitAll()  //비밀번호 초기화
