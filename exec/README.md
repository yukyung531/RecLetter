...
- **‘계정’ 클릭**
  ...
  <img width="800" alt="image" src="/exec/image/Untitled.png">

- **(2단계 인증이 되어 있지 않은 경우) 보안 탭 → 2단계 인증 진행**
- 
  <img width="800" alt="image" src="/exec/image/Untitled 1.png">

- **검색창에 ‘앱 비밀번호’ 검색 후 클릭**
- 
  <img width="800" alt="image" src="/exec/image/Untitled 2.png">

- **앱 이름 입력 후 ‘만들기’ 버튼 클릭**

  <img width="800" alt="image" src="/exec/image/Untitled 3.png">
  
- **생성된 앱 비밀번호 별도 저장 (재확인 불가)**

  → .env의 `MAIL_SECRET`

  <img width="800" alt="image" src="/exec/image/Untitled 4.png">
  
- **구글 Gmail → 설정(우측 상단 톱니바퀴 아이콘 클릭) → 모든 설정 보기**
- **‘전달 및 POP/IMAP’ 탭 → 아래와 같이 설정 → 변경사항 저장 클릭**

  <img width="800" alt="image" src="/exec/image/Untitled 5.png">
...
- 프로젝트 선택 → 새 프로젝트 → 만들기
  ...
  <img width="800" alt="image" src="/exec/image/Untitled 6.png">

- 생성한 프로젝트 선택
- API 및 서비스 > 사용자 인증 정보 > 사용자 인증 정보 만들기 > OAuth 클라이언트 ID > 동의 화면 구성

  <img width="800" alt="image" src="/exec/image/Untitled 7.png">

  <img width="800" alt="image" src="/exec/image/Untitled 8.png">
  
- User Type은 ‘외부’ 선택 후 ‘만들기’ 클릭

  <img width="800" alt="image" src="/exec/image/Untitled 9.png">
  

- [OAuth 동의 화면]
  - 앱 이름, 사용자 지원 이메일, 앱 도메인, 개발자 연락처 정보 입력 후 ‘저장 후 계속’ 버튼 클릭

  <img width="800" alt="image" src="/exec/image/Untitled 10.png">
  
- [범위]
  - ‘범위 추가 또는 삭제’ 버튼 클릭 → email, profile, openId 선택 후 아래 ‘업데이트’ 버튼 클릭

  <img width="800" alt="image" src="/exec/image/Untitled 11.png">
  
  - 저장 후 계속 버튼 클릭

  <img width="800" alt="image" src="/exec/image/Untitled 12.png">
  
- [테스트 사용자]
  - 테스트 사용자 필요 시 테스트 사용자 추가 후 ‘저장 후 계속’ 버튼 클릭

  <img width="800" alt="image" src="/exec/image/Untitled 13.png">
  
- 좌측 ‘사용자 인증 정보’ 클릭 → 사용자 인증 정보 만들기 > OAuth 클라이언트 ID

  <img width="800" alt="image" src="/exec/image/Untitled 14.png">
...
- 애플리케이션 유형, 이름, 승인된 리디렉션 URI 작성 후 ‘만들기’ 버튼 클릭
  ...
  <img width="800" alt="image" src="/exec/image/Untitled 15.png">
